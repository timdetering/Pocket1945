    ...
    public class Player : Sprite, IArmed, ICollidable
    {
        ...
        public override void Draw(Graphics g)
        {
            ...
            if (Status == PlayerStatus.Playing)
            {
                ...
                g.DrawImage(SpriteList.Instance.BigPlanes[index],
                    new Rectangle(x, y, spriteSize.Width, spriteSize.Height), 0, 0, spriteSize.Width, spriteSize.Height,
        ...
        {
            g.DrawImage(SpriteList.Instance.BigExplotion[(int)spriteIndex],
                new Rectangle(x, y, spriteSize.Width, spriteSize.Height), 0, 0, spriteSize.Width, spriteSize.Height,
                GraphicsUnit.Pixel, imgAttribs);
            spriteIndex += 0.5;
            if (spriteIndex == 7)
