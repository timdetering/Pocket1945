...
namespace Pocket1945
{
    ...
    public class Bullet : Sprite
    {
        ...
        /// <summary>
        /// The power of the buller. When the bullet hit a enemy or the 
        ...
        public Bullet(int outX, int outY, int bulletPower, double bulletSpeed, BulletType bulletType,
        ...
        /// <summary>
        /// Method setting bullet specific properties like sprite index and collision rectangle.
        /// </summary>
        ...
        public override void Draw(Graphics g)
        {
            ...
            g.DrawImage(SpriteList.Instance.Bullets[index], new Rectangle(x, y, spriteSize.Width, spriteSize.Height), 0,
