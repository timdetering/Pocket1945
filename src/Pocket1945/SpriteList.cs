...
namespace Pocket1945
{
    ...
    public class SpriteList
    {
        ...
        /// <summary>
        /// Public field giving access to an array of sprites used for a small explosion.
        /// </summary>
        public Bitmap[] SmallExplotion;

        /// <summary>
        /// Public field giving access to an array of sprites used for a big explosion.
        /// </summary>
        ...
        /// once a private Boolean is set to true/false indicating if the sprites
        ...
        public void LoadSprites()
        {
            if (!doneLoading)
            {
                ...
                Bitmap smallExplotion =
                    new Bitmap(asm.GetManifestResourceStream("Pocket1945.Data.Sprites.SmallExplotion.bmp"));
                Bitmap bigBackgroundElements =
                    new Bitmap(asm.GetManifestResourceStream("Pocket1945.Data.Sprites.BigBackgroundElements.bmp"));
                Bitmap bigExplotion =
                    new Bitmap(asm.GetManifestResourceStream("Pocket1945.Data.Sprites.BigExplotion.bmp"));
