...
namespace Pocket1945
{
    ...
    public abstract class Sprite : IDrawable
    {
        ...
        /// The method is virtual so that child classes can make it's own implementation
        /// of the method.
        /// </summary>
        /// <returns>True if the sprite is off the screen.</returns>
        public virtual bool IsOffScreen()
        {
            return (x > GameForm.GameArea.Width || x + spriteSize.Width < 0 || y > GameForm.GameArea.Height ||
                    y + spriteSize.Height < 0);
        }

        /// <summary>
        /// Method returning the collision bounds of the sprite.
        /// </summary>
        /// <returns>A rectangle representing the collision area of the sprite.</returns>
        ...
        /// <summary>
        /// Instantiates a new Sprite class.
        /// </summary>
        public Sprite()
        {
            x = 0;
