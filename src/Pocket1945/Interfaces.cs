...
namespace Pocket1945
{
    ...
    /// The method contains one method returning a rectangle defining the collision area.
    /// </summary>
    public interface ICollidable
    {
        /// <summary>
        /// Method returning the collision area of the game object.
        /// </summary>
        /// <returns>A rectangle defining the collision area of the game object.</returns>
